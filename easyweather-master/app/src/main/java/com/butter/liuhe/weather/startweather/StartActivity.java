...
import com.butter.liuhe.weather.home.MainActivity;
...
public class StartActivity extends AppCompatActivity {
    ...
    private static final String ACTION_ADD_CITY = "ccom.butter.liuhe.weather.startweather" +
            ".Activity.action.addCity";

    private static final String ACTION_GET_WEATHER = "com.butter.liuhe.weather.startweather" +
            ".Activity.action.getWeather";

    private static final String ACTION_START_NOTIFICATION = "com.butter.liuhe.weather" +
            ".startweather.Activity.action.notification";


    private static final String ACTION_FILE_PROCESS = "com.butter.liuhe.weather.startweather" +
